...
const Sidebar = ({ activeView, onNavigate, onNavigateBack, onNavigateHome }) => {
    ...
    return (
        <div className="w-64 h-screen bg-white/70 dark:bg-gray-900/50 backdrop-blur-xl border-r border-gray-200 dark:border-gray-800 flex flex-col justify-between p-6 fixed left-0 top-0 transition-colors duration-200 z-30">
            <div>
